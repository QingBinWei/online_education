...
public class RoleController {
    ...
    public ReturnResult index(
        ...
        return ReturnResult.ok().data("items", pageParam.getRecords()).data("total", pageParam.getTotal());
    }
    ...
    public ReturnResult get(@PathVariable String id) {
        ...
        return ReturnResult.ok().data("item", role);
    }
    ...
    @PutMapping("update")
    public ReturnResult updateById(@RequestBody Role role) {
